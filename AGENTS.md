...
- Live-verify behavioural changes in a debug Chrome (see below) before shipping.

---

## Cartel Empire — `cartel-empire/`
...
4. Play in that window; keep it open. The `dev/browser-inspect/` Playwright
   ...
   localStorage. See `cartel-empire/dev/browser-inspect/README.md`.
